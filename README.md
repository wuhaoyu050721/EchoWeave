...
织语是一款为中文角色扮演与长篇叙事场景设计的类酒馆应用，基于 Vue 3 与 uni-app 构建。它支持自定义模型接口、角色卡、世界书、多角色群聊及自动维护长期设定的故事模式，并将聊天记录、角色资料和密钥优先保存在本地设备中。
...
| 独立故事角色库 | 故事续写对话 |
| --- | --- |
| <img src="docs/images/echo-weave-story-library.png" width="390" alt="EchoWeave 独立故事角色库"> | <img src="docs/images/echo-weave-story-chat.png" width="390" alt="EchoWeave 故事续写对话"> |
...
5. 需要长篇叙事时，在“故事”页单独导入故事角色卡并开始故事；输入事件走向，或留空发送让 AI 继续续写。
